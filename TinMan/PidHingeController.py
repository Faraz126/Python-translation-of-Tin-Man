...
def _target_angle_setter_(self,value):
    ...
    Hinge.set_control_function(self.control_function)
...
def __str__(self):
    return "<PID hinge = " + hinge.perceptor_label + " " + str(self.proportional_gain) + " " + str(self.integral_gain) + " " + str(self.derivative_gain) ">"
