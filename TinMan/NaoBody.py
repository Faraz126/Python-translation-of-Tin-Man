...
class NaoBody:
    ...
    def __init__(self, rsg_path = "rsg/agent/nao/nao.rsg"):
        ...
        self.all_hinges = [self.hj1, self.hj2, self.laj1, self.laj2, self.laj3, self.laj4,
        self.raj1,self.raj2,self.raj3, self.raj4, self.llj1,self.llj2, self.llj3,self.llj4,
        self.llj5,self.llj6, self.rlj1, self.rlj2, self.rlj3, self.rlj4,self.rlj5, self.rlj6]
